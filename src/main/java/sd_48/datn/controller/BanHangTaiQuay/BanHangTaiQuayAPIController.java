package sd_48.datn.controller.BanHangTaiQuay;
...
import sd_48.datn.service.HoaDon.HoaDonChiTietServie;
import sd_48.datn.service.HoaDon.HoaDonService;
import sd_48.datn.service.KhachHangService;
import sd_48.datn.service.admin.MauSacService;
import sd_48.datn.service.admin.SizeService;
...
public class BanHangTaiQuayAPIController {
    ...
    @Autowired
    private GiayTheThaoRepository repogtt;

    @GetMapping("/gtt")
    private List<GiayTheThao> getAllGtt() {
        return repogtt.findByTrangThai(1);
    }
