...
import sd_48.datn.service.HoaDon.HoaDonServiceImpl;
import sd_48.datn.service.impl.ChuongTrinhGiamGiaHoaDonImpl;
...
public class HoaDonController {
    ...
    public String showViewHoaDon(
        ...
        if (session.getAttribute("khachHangLog") != null) {
            ...
            if (hoaDon != null) {
                ...
                for (HoaDonChiTiet hoaDonChiTiet : hoaDonChiTietList) {
                    UUID idGiayTheThao = hoaDonChiTiet.getGiayTheThaoChiTiet().getGiayTheThao().getId();
    ...
    public ModelAndView hoaDonChoXacNhan(
        ...
        Page<HoaDon> hoaDonPage = hoaDonServiceImpl.listHoaDonFindByKhachHangAndTrangThai(khachHang.getId(), 1, pageNo, 5);
        // Sắp xếp danh sách đơn hàng theo ngày thanh toán tăng dần (mới nhất lên đầu tiên)
        List<HoaDon> sortedList = hoaDonPage
                .getContent()
                .stream()
                .sorted(Comparator.comparing(HoaDon::getNgayThanhToan))
                .collect(Collectors.toList());

        model.addAttribute("page", new PageImpl<>(sortedList,hoaDonPage.getPageable(), hoaDonPage.getTotalElements()));
...
//////////////////////////////////////////////////////////////////////////
    ...
    public ModelAndView adminXacNhanDonHangChoKhachHang(
        ...
        Page<HoaDon> hoaDonPage = hoaDonServiceImpl.listHoaDonFindByTrangThai(pageNo, 5, 1);
        ...
        Page<HoaDon> sortedPage = new PageImpl<>(sortedList, hoaDonPage.getPageable(), hoaDonPage.getTotalElements());
...
//        return "redirect:/Admin/HoaDon/XacNhanHoaDonGiaoHangThanhCongHoanThanh";
    ...
    public String adminXacNhanHuyDonHangCuaKhachHang(
        ...
        if (session.getAttribute("userLog") != null) {
            ...
            message.setSubject("Cửa hàng bán giầy thể thao SportShoes xin thông báo");
            message.setText(
                    "Mã hóa đơn : " + maHoaDon +
                            "\n" +
