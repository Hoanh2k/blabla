...
<div class="container" style="padding-top: 90px">
    ...
    <table class="table table-striped;" style="border-radius: 10px 10px 10px;border: 1px solid #FAFAFA ; background-color: #FAFAFA">
        <tr>
            ...
            <td scope="col" style="color: black;font-weight: bold;font-size: 17px;background-color: #bac8f3;width: 170px">Tổng tiền hàng</td>
            <td scope="col" style="color: black;font-weight: bold;font-size: 17px;background-color: #bac8f3;width: 170px">Phí vận chuyển</td>
            <td scope="col" style="color: black;font-weight: bold;font-size: 17px;background-color: #bac8f3;width: 170px">Thành tiền</td>
        ...
        <tr>
            ...
            <td style="font-size: 17px;color: black">
                <fmt:formatNumber type="" value="${hoaDonView.thanhTien + hoaDonView.phiShip}" pattern="#,##0" />
            </td>
            <td style="font-size: 17px;color: black">
                ${hoaDonView.ghiChu}
            </td>
    ...
    <c:forEach items="${hoaDonChiTietList}" var="list" varStatus="i">
        <p style="border: 1px solid #FAFAFA; background-color: #FAFAFA;border-radius: 5px 5px 5px;height: 100px">
            ...
            <span style="display: inline-block;padding-left: 20px;color: black;font-size: 16px;margin-top: 30px">Giá bán:
                <fmt:formatNumber type="" value="${list.giayTheThaoChiTiet.giayTheThao.giaBan * (100 - saleList[i.index])/100} " pattern="#,##0"/> VNĐ
            </span>
