                    ...
                    <tr>
                        ...
                        <td>
                            <button formaction="/KhachHang/HoaDon/XacNhanGiaoHangThanhCong" name="thanhCong" value="${list.id}"
                                    class="btn btn-success me-2">Thành Công
                            </button>
                            <button style="margin-top: 10px" type="submit" formaction="/KhachHang/viewThongTinSanPhamMuaChoXacNhan" name="idHoaDonViewThongTinSanPhamChoXacNhan" value="${list.id}"
