            ...
            <div class="row">
                <div class="col-3" style="">
                    ...
                    <div>
                        ...
                        <p style="color: black">Giá tối đa: <span id="maxPrice">2.000.000</span></p>
                    </div>
                    ...
                    <h4 style="margin-bottom: 20px;margin-top: 20px">Trọng lượng</h4>
                ...
                <div class="col-9" style="">
                    <div class="row">
                        ...
                        <div id="product-list" class="row">
                            ...
                            <c:forEach var="listGiay" items="${listPage}" varStatus="i">
                                    ...
                                    >
                                        ...
                                        <a href="${pageContext.request.contextPath}/GiayTheThao/detailThongTinGiayTheThao/${listGiay.id}">
                                            <div class="card" style="height: 300px;width: 200px">
                                                ...
                                                <div class="card-body">
                                                    <h6 class="card-title"
                                                        style="text-align: center;font-size: 12px;">${listGiay.tenGiayTheThao}</h6>
                                                    <c:choose>
                                                        <c:when test="${saleList != null && saleList.size() > i.index && saleList[i.index] != null && saleList[i.index] != 1}">
                                                            <div class="price">
                    ...
                    <span style="color: gray;font-size: 10px; ">
                        <fmt:formatNumber type="" value="${listGiay.giaBan}" pattern="#,##0"/>
                                                                    ...
                                                                    <strong style="font-size: 14px; color: red;margin-left: 5px">
                    <span style="font-size: 14px">
                        <fmt:formatNumber type="" value="${listGiay.giaBan * (100 - saleList[i.index]) / 100}" pattern="#,##0"/> VNĐ
                    </span>
                                                                    </strong>
                                                                </h6>
                                                            </div>
                                                        ...
                                                        <c:otherwise>
                                                            <div class="price">
                                                                <h6 style="text-align: center">
                                                                    <strong style="font-size: 14px; color: black;margin-left: 5px">
                    <span style="font-size: 14px">
