    ...
    <form action="${pageContext.request.contextPath}/GiayTheThao/nguoiDung/addHoaDon" method="post"
        ...
        <table style="border:1px solid #FAFAFA; width:1150px; margin-top: 40px">
            ...
            <tr>
                ...
                <th scope="col" style="text-align: center;color: black">Tên giày thể thao</th>
            ...
            <c:forEach var="gioHangChiTiet" items="${listGioHangChiTiet}" varStatus="i">
                <tr>
                    <td style="padding-top: 20px; text-align: center; color: black">
                        ...
                        <input type="checkbox" name="chon" value="${i.index}"
                               id="chon-${gioHangChiTiet.giayTheThaoChiTiet.id}">
                    ...
                    <td style="padding-top: 20px; text-align: center; color: black">
                        <a style="color: black;" href="${pageContext.request.contextPath}/GiayTheThao/detailThongTinGiayTheThao/${gioHangChiTiet.giayTheThaoChiTiet.giayTheThao.id}">
                                ${gioHangChiTiet.giayTheThaoChiTiet.giayTheThao.tenGiayTheThao}
                        </a>
                    </td>
                    <td style="padding-top: 20px; text-align: center; color: black">
                        <img style="width: 100px;margin-bottom: 10px"
                             src="/upload/${gioHangChiTiet.giayTheThaoChiTiet.giayTheThao.image.get(0).link}" alt="">
                    </td>
                    <td style="padding-top: 20px; text-align: center; color: black">
                    ...
                    <td style="padding-top: 20px; text-align: center; color: black">
                        ...
                        <fmt:formatNumber type=""
                                          value="${gioHangChiTiet.giayTheThaoChiTiet.giayTheThao.giaBan * (100 - saleList[i.index])/100}"
                                          pattern="#,##0"/> VNĐ
...
<%--                                            </td>--%>
                    ...
                    <td style="padding-top: 20px; text-align: center; color: black">
                        <button style="width: 30px" type="button" class="btn"
                                onclick="updateQuantity('decrease', ${i.index})">-
                        </button>

                        <input id="soLuong-${i.index}" style="width: 45px" name="soLuong" type="number"
                               value="${gioHangChiTiet.soLuong}"
                               onchange="validateAndSetQuantity(this, ${gioHangChiTiet.giayTheThaoChiTiet.soLuong})"
                               data-available-quantity="${gioHangChiTiet.giayTheThaoChiTiet.soLuong}">


                        <button style="width: 30px" type="button" class="btn"
                                onclick="updateQuantity('increase', ${i.index})">+
                        </button>
...
<script>
    function validateAndSetQuantity(input, availableQuantity) {
        ...
        if (quantity > availableQuantity) {
            ...
            Swal.fire({
                ...
                text: 'Số lượng mua tối đa là ' + availableQuantity + '!',
            });
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    let deleteButton = input.closest('tr').querySelector('button[formaction]');

                    // Thực hiện xóa sản phẩm bằng formaction của nút
                    deleteButton.click();
                } else {
                    // Nếu người dùng chọn "Không", đặt giá trị nhập vào là 0
                    input.value = 1;
                }
            });
        ...
        if (operation === "increase") {
            ...
            if (currentQuantity > 1) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        // Tìm nút xóa sản phẩm
                        let deleteButton = quantityInput.closest('tr').querySelector('button[formaction]');
