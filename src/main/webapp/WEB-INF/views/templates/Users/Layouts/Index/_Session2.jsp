                        ...
                        <div class="single-deal">
                            ...
                            <a href="../../../../../../resources/img/category/c1.jpg" class="img-pop-up" target="_blank">
                                <div class="deal-details">
                                    <h6 class="deal-title">Giày thể thao phong cách thời trang</h6>
                                </div>
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4">
                        <div class="single-deal">
                            ...
                            <a href="img/category/c2.jpg" class="img-pop-up" target="_blank">
                                <div class="deal-details">
                                    <h6 class="deal-title">Cho những người yêu thể thao</h6>
                                </div>
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4">
                        <div class="single-deal">
                            ...
                            <a href="../../../../../../resources/img/category/c3.jpg" class="img-pop-up" target="_blank">
                                <div class="deal-details">
                                    <h6 class="deal-title">Nâng tầm phong cách, nâng niu đôi chân</h6>
                                </div>
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-8 col-md-8">
                        <div class="single-deal">
                            ...
                            <a href="../../../../../../resources/img/category/c4.jpg" class="img-pop-up" target="_blank">
                                <div class="deal-details">
                                    <h6 class="deal-title">Bước chân vững vàng, chinh phục mọi thử thách</h6>
                                </div>
                            </a>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-deal">
                    ...
                    <a href="../../../../../../resources/img/category/c5.jpg" class="img-pop-up" target="_blank">
                        <div class="deal-details">
                            <h6 class="deal-title">Mua sắm thả ga, giá cực ưu đãi!</h6>
                        </div>
                    </a>
                </div>
            </div>
