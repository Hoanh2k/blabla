            ...
            <div class="text_Detail" style="margin-top: 30px">
                ...
                <span style="color: black;font-weight: bold;font-size: 17px">
                    ...
                    <span style="color: gray;font-size: 15px; ">
                        ...
                        <strong style="font-size: 17px; color: red;margin-left: 10px">
            ...
            <div class="row" style="width: 1160px; margin-top: 30px">
                <div class="col-1">
                    <img src="../../../../../../resources/img/banner/banner-img1.png" alt=""
                         style="width: 100px; border: 1px solid white; border-radius: 1000px 1500px 700px; ">
                </div>
                <div class="col-3" style="margin-left: 30px">
                    <h4 style="margin-top: 15px">SPORT SHOES</h4>
