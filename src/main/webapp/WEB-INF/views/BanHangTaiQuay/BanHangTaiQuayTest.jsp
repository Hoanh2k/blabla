...
<header class="p-3 mb-3 border-bottom">
    <div class="container">
        ...
        >
            <a href="http://localhost:8080/TrangChu/Admin/home" class="d-flex align-items-center mb-2 mb-lg-0 text-dark text-decoration-none" id="banner">SportShoes</a>
        ...
        Promise.all([getAllMSByIdGtt(id), getAllSizeByIdGtt(id)])
            .then(([ms, size])=>{
                ...
                if(!isNaN(soTienDaGiam)&&soTienDaGiam!=0){
                    ...
                    document.getElementById('detailProduct-price').innerHTML= sale+`  <del >`+price+`</del>  `;
                } else {
                    productPrice = giaBan;
