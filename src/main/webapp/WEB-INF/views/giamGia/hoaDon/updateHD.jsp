    ...
    <div>
        ...
        >
            <div class="row">
                ...
                <div class="col-6">
                    <label class="label" style="font-size: 17px;font-weight: bold;color: black">Giá trị giảm &lt;= 100 (%) <span style="color: red">*</span></label>
                    <sf:input
                            path="phanTramGiam"
                            type="number"
            ...
            if (!confirmUpdate) {
                ...
                return false;
                   ...
                   var checkValidate = true;
                    ...
                    if(ptg<=0||ptg>100){
                        error_phanTramGiam.innerHTML = "Giá trị giảm phải lớn hơn 0 và nhỏ hơn 100";
                        checkValidate = false;
                    } 
                    if(sl<=0){
